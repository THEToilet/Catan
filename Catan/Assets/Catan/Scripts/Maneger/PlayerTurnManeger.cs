...
namespace Catan.Scripts.Manager
{
    public class PlayerTurnManeger : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (progressStateManeger._currentProgressState.Value == ProgressState.Initialization)
            {

            }
            else if (progressStateManeger._currentProgressState.Value == ProgressState.Battle)
            {
